...
var api = (__webpack_require__(/*! axios */ "./node_modules/axios/index.js")["default"]);

function retrieveExercises() {
  return _retrieveExercises.apply(this, arguments);
}

function _retrieveExercises() {
  _retrieveExercises = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return axios.get('/api/exercises').then(function (r) {
...
var jar = (0,codejar__WEBPACK_IMPORTED_MODULE_2__.CodeJar)(document.querySelector('.editor'), (prismjs__WEBPACK_IMPORTED_MODULE_3___default().highlightElement), options);
var select = document.querySelector('.exercise');
